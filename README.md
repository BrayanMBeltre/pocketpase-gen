...
`pb-gen` simplifies PocketBase development in Go by automatically
...
1. Install the binary using
   `go install github.com/brayanmbeltre/pb-gen/cmd/pb-gen`
...
"content", and "author". After running `pb-gen`, you'll have a
...
```go
// Code generated by pb-gen. DO NOT EDIT.
package collections
